...
```shell
go get github.com/yerkinalagozov/binance-go/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/yerkinalagozov/binance-go/v1
```
...
```golang
import (
    "github.com/yerkinalagozov/binance-go/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/yerkinalagozov/binance-go) for full references.
...
```go
import (
    "github.com/yerkinalagozov/binance-go/v2/futures"
)
...
```go
import (
    "github.com/yerkinalagozov/binance-go/v2/delivery"
)
